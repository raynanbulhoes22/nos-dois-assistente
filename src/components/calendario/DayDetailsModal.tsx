                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {evento.categoria && (
                          <p className="text-sm text-muted-foreground mb-1">{evento.categoria}</p>
                        )}
                        ...
                        {evento.detalhes?.numeroCartao && (
                          <p className="text-sm text-muted-foreground mb-1">Final {evento.detalhes.numeroCartao}</p>
                        )}
                      </div>
                      <div className="flex-shrink-0 text-right">
                        <div className={`font-semibold ${evento.isEntrada ? 'text-success' : 'text-destructive'}`}>
